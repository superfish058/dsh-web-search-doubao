						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									style: state.keyConfigured ? badgeConfiguredStyle : badgeMissingStyle,
									children: props.t(state.keyConfigured ? "keyConfigured" : "keyMissing")
								}) : null]
							}),
		...
		function createSearchProviderCard(config) {
			...
			function apply(ctx) {
				...
				const flash = (message) => {
					...
					if (message !== void 0) messageTimer = setTimeout(() => setSnapshot({ message: void 0 }), 4e3);
				};
				/** Store every non-blank staged value under its credential reference. */
				const save = async (values) => {
					if (api?.credentials?.set === void 0) return;
				...
				const reset = async () => {
					if (api?.credentials?.unset === void 0) return;
					setSnapshot({ saving: true });
